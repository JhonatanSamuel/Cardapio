...
//fechar o modal apertando o fechar 
closeModalBtn.addEventListener("click", function() {
    cartModal.style.display = "none"
})

//Ao clicar no botão adicionar no carrinho
...
function updateCartModal() {
    ...
    cart.forEach(item => {
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-green-500">Qtd: ${item.quantity}</p>
    ...
    // Mudando o contador do carrinho
